...
pub mod obbench {
    ...
    impl<C: rt::Invoker> MeterClient<C> {
        ...
        pub fn echo_many(&mut self, items: crate::f_bench::obbench::TextSeq) -> Result<crate::f_bench::obbench::TextSeq, rt::GiopError> {
            let mut __probe = rt::Encoder::new(self.conn.endian());
        ...
        pub fn echo_text(&mut self, msg: String) -> Result<String, rt::GiopError> {
            let mut __probe = rt::Encoder::new(self.conn.endian());
            msg.put(&mut __probe)?;
            __probe.finish().map_err(rt::GiopError::Cdr)?;
    ...
    impl From<rt::SystemException> for MeterFault {
        fn from(__ex: rt::SystemException) -> Self {
            Self::System(__ex)
        }
    }
    impl PartialEq for MeterFault {
    ...
    impl<'a> MeterTarget<'a> {
        ...
        pub fn new(oid: &'a str, refs: &'a MeterRefs) -> Self {
            Self { oid, refs }
        }
    ...
    pub trait MeterServant {
        ...
        fn forward(&mut self, __at: &MeterTarget<'_>) -> Option<rt::Ior> {
            let _ = __at;
            None
        }
        ...
        fn redirect(&mut self, __at: &MeterTarget<'_>) -> Option<rt::Forward> {
            self.forward(__at).map(rt::Forward::Temporary)
        }
        /// Adds two signed 32-bit integers; the scalar shape
        ///
        /// `add` on the wire.
        fn add(&mut self, __at: &MeterTarget<'_>, a: i32, b: i32) -> Result<i32, MeterFault>;
        /// Returns the list of strings it was given, unchanged
        ///
        /// `echo_many` on the wire.
        fn echo_many(&mut self, __at: &MeterTarget<'_>, items: crate::f_bench::obbench::TextSeq) -> Result<crate::f_bench::obbench::TextSeq, MeterFault>;
        /// Returns the string it was given, unchanged
        ///
        /// `echo_text` on the wire.
        fn echo_text(&mut self, __at: &MeterTarget<'_>, msg: String) -> Result<String, MeterFault>;
    }
    ...
    pub trait MeterObject {
        ...
        ///
        /// `echo_many` on the wire.
        fn echo_many(&mut self, items: crate::f_bench::obbench::TextSeq) -> Result<crate::f_bench::obbench::TextSeq, MeterFault>;
        /// Returns the string it was given, unchanged
        ///
        /// `echo_text` on the wire.
    ...
    impl<S: MeterObject> Default for MeterObjects<S> {
        fn default() -> Self {
    ...
    impl<S: MeterObject> MeterServant for MeterObjects<S> {
        ...
        fn add(&mut self, __at: &MeterTarget<'_>, a: i32, b: i32) -> Result<i32, MeterFault> {
            match self.objects.get_mut(__at.oid()) {
                ...
                None => Err(MeterFault::System(rt::raise::object_not_exist().did_not_run())),
            }
        }
        fn echo_many(&mut self, __at: &MeterTarget<'_>, items: crate::f_bench::obbench::TextSeq) -> Result<crate::f_bench::obbench::TextSeq, MeterFault> {
            match self.objects.get_mut(__at.oid()) {
    ...
    impl<S: MeterServant> rt::Dispatch for MeterSkeleton<S> {
        ...
        fn dispatch_body(
            ...
            match __req.operation.as_str() {
                "add" => {
                    let a: i32 = Cdr::get(&mut __args)
                        .map_err(|_| rt::SystemException::marshal())?;
                    let b: i32 = Cdr::get(&mut __args)
                        .map_err(|_| rt::SystemException::marshal())?;
                ...
                "echo_many" => {
                    let items: crate::f_bench::obbench::TextSeq = Cdr::get(&mut __args)
                        .map_err(|_| rt::SystemException::marshal())?;
                ...
                "echo_text" => {
                    let msg: String = Cdr::get(&mut __args)
                        .map_err(|_| rt::SystemException::marshal())?;
